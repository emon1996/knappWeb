...
// Unique build timestamp to bypass CDN cache
const BUILD_CACHE_BUSTER = "fresh-20260130-1100"
  ...
  const activeProjects = [
    {
      ...
      images: [
        `/images/cr160-aerial-fresh-001.jpg?b=${BUILD_CACHE_BUSTER}`,
        `/images/cr160-aerial-fresh-002.jpg?b=${BUILD_CACHE_BUSTER}`,
        `/images/cr160-aerial-fresh-003.jpg?b=${BUILD_CACHE_BUSTER}`,
        `/images/cr160-aerial-fresh-004.jpg?b=${BUILD_CACHE_BUSTER}`,
        `/images/cr160-aerial-fresh-005.jpg?b=${BUILD_CACHE_BUSTER}`
      ]
    },
    {
      id: 2,
      ...
      images: [
        `/images/solid-work-aerial-1.jpg?b=${BUILD_CACHE_BUSTER}`,
        `/images/solid-work-aerial-2.jpg?b=${BUILD_CACHE_BUSTER}`
      ]
    },
    {
      id: 3,
      ...
      images: [
        `/images/josiah-road.jpg?b=${BUILD_CACHE_BUSTER}`,
        `/images/josiah-utility.jpg?b=${BUILD_CACHE_BUSTER}`
      ]
    }
  ]
