...
// Unique build timestamp to bypass CDN cache - CHANGE THIS VALUE TO FORCE FRESH IMAGES
...
function HeroCarousel() {
  ...
  const images = [
    ...
    `/images/hero-fresh-004.jpg?b=${BUILD_CACHE_BUSTER}`,
    `/images/hero-fresh-005.jpg?b=${BUILD_CACHE_BUSTER}`
  ]
